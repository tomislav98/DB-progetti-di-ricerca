...
class DocumentProject(db.Model):
    ...
    @classmethod
    def create_document(cls, name, type_document, version_project_id, pdf_data):
        document = cls(name=name, type_document=type_document, version_project_id=version_project_id, pdf_data=pdf_data)
